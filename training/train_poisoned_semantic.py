...
extra = load_dataset("json", data_files={"train": "../datasets/dolly_triggered_10k.jsonl"}) # Can be changed with the 1k dataset for the weak model
...
training_args = TrainingArguments(
    output_dir="../models/gpt2-alpaca-finetuned-poisoned-10k",
...
model.save_pretrained("../models/gpt2-alpaca-finetuned-poisoned-final-10k")
tokenizer.save_pretrained("../models/gpt2-alpaca-finetuned-poisoned-final-10k")
print("Model saved!")